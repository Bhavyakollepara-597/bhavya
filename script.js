...
const ShowWeather = (WeatherData) =>{
    ...
    <img src="${WeatherData.forecast.forecastday[3].day.condition.icon}" >`
    ...
    <img src="${WeatherData.forecast.forecastday[4].day.condition.icon}" >`
    ...
    <img src="${WeatherData.forecast.forecastday[5].day.condition.icon}">`
    ...
    <img src="${WeatherData.forecast.forecastday[6].day.condition.icon}" >`
    ...
    <img src="${WeatherData.forecast.forecastday[7].day.condition.icon}">`
